<?php
	...
	class CAplicacion
	{
		...
		private $_prop=array();
		private $_sesion; //instancia de CSesion
		private $_Acceso; //instancia de CAcceso
		private $_ACL; //instancia de CACLBD
		...
		public function __construct(array $config)
		{
			...
			//CACLDB
			//Se comprueba si se ha dado acceso a la BBD también
			if ( (isset($config["ACL"]) && $config["ACL"]["controlAutomatico"] === true) 
					&& (isset($config["BD"]) && $config["BD"]["hay"]===true)){
