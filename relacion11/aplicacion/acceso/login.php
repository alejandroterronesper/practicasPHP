            ...
            if ($listaACL -> esValido($nick, $contrasenha)){
                ...
                if ($listaACL->getBorrado($codUser)){ //si da true es que esta borrado
                    ...
                    if (isset($acceso)){
                        ...
                        //compruebo que el usuario no este borrado
...
$_posPagina = [
    ...
    [
        "texto" => "Login",
        "url" => "/aplicacion/acceso/login.php"
    ]
];
...
cabecera();
finCabecera();
inicioCuerpo("Formulario de login", $_posPagina );
...
?>
    ...
    <form action="" method="post" class="formulario">
        <fieldset>
            ...
            <!--Contraseña -->
            <label for="contrasenha"><b>Contraseña:</b></label>
    ...
    <form class="formulario">
        <fieldset>
            <legend><b>¿No tienes cuenta?</b></legend>
            <button class="boton"> <a href="../usuarios/nuevoUsuario.php">Registrate</a> </button>
        </fieldset>
    </form>
