...
/**
 * clase acceso  
 * se tiene informacion del usuario registrado
 * ademas de guardar informacion del acceso de usuario 
 * en la aplicacion para ser accesible desde todas las paginas
 * Esto representa un estado y se guarda en sesiones
 */
class Acceso {
    ...
    public function puedePermiso(int $numero):bool {
        ...
        if ($this->hayUsuario()){
            ...
            if (validaRango($numero,$this->_permisos,1)){
