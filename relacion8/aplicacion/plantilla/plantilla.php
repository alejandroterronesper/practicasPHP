        ...
        <div id="documento">
                    ...
                    <form action="" method="post">
                        <?php
                            if ($acceso->hayUsuario() === true){
                                ?>
                                <!--Usuario actual -->
                                <p> <b>Bienvenido:</b> <i>  <?php echo $acceso->getNick() ?> </i><br></p>
                                <!--Cerrar sesion -->
            ...
            <div id="barraMenu">
                <ul>
                    ...
                    <?php
                        if ($_SERVER["PHP_SELF"] !== "/aplicacion/usuarios/index.php" && ($acceso->hayUsuario())){
                            ?>
                            <li><a href="/aplicacion/usuarios/index.php">Ver usuarios</a></li>
                            <?php
                        }
                    ?>
